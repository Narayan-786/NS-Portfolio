      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center md:text-left">
            <h3 className="text-xl font-bold mb-4">Narayan Sahu</h3>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end space-x-4">
              ...
              <a
                href="https://www.linkedin.com/in/narayan-sahu-5565ab322/"
                className="text-white/80 hover:text-teal-200 transition-colors duration-200"
              >
        ...
        <div className="mt-8 pt-8 border-t border-white/10 text-center">
          <p className="text-white/80">© 2025 Narayan Sahu. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
